...
.field private static final QUANTUMFORSYNC:J = 0x57e40L
...
.method private static final dumpAlarmList(Ljava/io/PrintWriter;Ljava/util/ArrayList;Ljava/lang/String;JJ)V
    ...
    invoke-virtual {v0, p0, v7, v4, v5}, Lcom/android/server/AlarmManagerService$Alarm;->dump(Ljava/io/PrintWriter;Ljava/lang/String;J)V
...
.method private isForceSync(Ljava/lang/String;)Z
    ...
    .prologue
    .line 769
    const-string v1, "persist.use_force_sync"
    ...
    .line 771
    iget-object v1, p0, Lcom/android/server/AlarmManagerService;->map:Ljava/util/Map;
...
.method private rescheduleKernelAlarmsLocked()V
    ...
    .line 901
    iget-wide v6, v3, Lcom/android/server/AlarmManagerService$Batch;->start:J
    ...
    iget-wide v7, v3, Lcom/android/server/AlarmManagerService$Batch;->start:J
    ...
    iget-wide v6, p0, Lcom/android/server/AlarmManagerService;->mNextRtcWakeup:J
    ...
    invoke-virtual {v2, v6, v7}, Lcom/android/server/AlarmManagerService$Batch;->getWhenByElapsedTime(J)J
    ...
    const-string v8, "Jason setLocked RTC_POWEROFF_WAKEUP when="
    ...
    invoke-virtual {v2}, Lcom/android/server/AlarmManagerService$Batch;->isRtcPowerOffWakeup_AutoStart()Z
    ...
    .line 920
    :cond_2
    invoke-direct {p0, v0}, Lcom/android/server/AlarmManagerService;->saveRtcType(I)V
...
.method private saveRtcType(I)V
    .locals 9
...
.method private triggerAlarmsLocked(Ljava/util/ArrayList;JJ)V
    ...
    invoke-virtual {v0, v1, v2, v6, v7}, Lcom/android/server/AlarmManagerService;->checkIfSync(Ljava/lang/String;IJ)Z
    ...
    .restart local v28    # "pkgName":Ljava/lang/String;
    :cond_4
    move-object/from16 v0, v23
...
.method public checkIfSync(Ljava/lang/String;IJ)Z
    .locals 7
    .param p1, "pkgName"    # Ljava/lang/String;
    .param p2, "type"    # I
    .param p3, "interval"    # J
    ...
    .line 785
    :cond_0
    iget-object v5, p0, Lcom/android/server/AlarmManagerService;->map:Ljava/util/Map;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/AlarmManagerService;->isForceSync(Ljava/lang/String;)Z
...
.method public removeEx(I)V
    ...
    .line 1420
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/android/server/AlarmManagerService;->removeLockedEx(I)V
...
.method public removeLockedEx(I)V
    .locals 16
    .param p1, "type"    # I
    ...
    iget v1, v8, Lcom/android/server/AlarmManagerService$Alarm;->rtcType:I
    ...
    const-string v3, "Jason Clear alarm type="
    ...
    invoke-virtual {v10, v1}, Lcom/android/server/AlarmManagerService$Batch;->remove(Landroid/app/PendingIntent;)Z
    ...
    const-string v2, "Jason removeEx(operation) changed bounds; rebatching"
...
.method public set(IJJJLandroid/app/PendingIntent;ZLandroid/os/WorkSource;)V
    ...
    iget-object v7, v0, Lcom/android/server/AlarmManagerService;->mContext:Landroid/content/Context;
    ...
    invoke-static/range {v7 .. v17}, Lcom/android/server/ExtraAlarmManagerService;->recalculateWindowLength(Landroid/content/Context;IJJJLandroid/app/PendingIntent;ZLandroid/os/WorkSource;)J
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/android/server/AlarmManagerService;->checkIfSync(Ljava/lang/String;IJ)Z
    ...
    .line 660
    .local v27, "adjustedTriggerTime":J
    :goto_3
    ...
    const-string v11, "qb-1: sync alarm pkgName="
    ...
    .line 673
    .end local v25    # "adjustInterval":J
    .end local v27    # "adjustedTriggerTime":J
    .end local v29    # "isRtc":Z
    .end local v30    # "offset":J
    .end local v32    # "para1":J
    .end local v34    # "para2":J
    .end local v37    # "skew":J
    :cond_7
    const/4 v9, 0x4
    ...
    invoke-direct/range {v9 .. v24}, Lcom/android/server/AlarmManagerService;->setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;)V
    ...
    .restart local v25    # "adjustInterval":J
    .restart local v32    # "para1":J
    .restart local v34    # "para2":J
    :cond_9
    const/16 v29, 0x0
    ...
    .restart local v37    # "skew":J
    :cond_b
    move-wide/from16 v27, p2

    .restart local v27    # "adjustedTriggerTime":J
    goto/16 :goto_3
    ...
    .line 684
    invoke-static/range {v5 .. v10}, Lcom/android/server/AlarmManagerService;->maxTriggerTime(JJJ)J
