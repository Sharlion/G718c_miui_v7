...
.method private cleanUp()Z
    ...
    .line 8368
    const-string v7, "/system/vendor/preload"
    ...
    const-string v9, "Package source "
    ...
    .line 8380
    .local v3, "publicSourceFile":Ljava/io/File;
    ...
    const-string v9, "Package public source "
    ...
    .line 8388
    .end local v3    # "publicSourceFile":Ljava/io/File;
    :cond_3
    iget-object v7, p0, Lcom/android/server/pm/PackageManagerService$FileInstallArgs;->libraryPath:Ljava/lang/String;
    ...
    .line 8390
    .local v1, "nativeLibraryFile":Ljava/io/File;
    invoke-static {v1}, Lcom/android/internal/content/NativeLibraryHelper;->removeNativeBinariesFromDirLI(Ljava/io/File;)Z
    ...
    const-string v9, "Couldn\'t delete native library directory "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/server/pm/PackageManagerService$FileInstallArgs;->libraryPath:Ljava/lang/String;
    ...
    .line 8396
    .end local v1    # "nativeLibraryFile":Ljava/io/File;
    :cond_4
    return v4
.end method
