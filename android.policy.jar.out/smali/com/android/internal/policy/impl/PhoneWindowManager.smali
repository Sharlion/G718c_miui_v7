...
.field private static final MSG_BLACKSCREEN_GESTURE_ANIMATION:I = 0x5
...
.field mBroadCastBlackguestWakeLock:Z

.field mBroadcastWakeLock:Landroid/os/PowerManager$WakeLock;

.field mBroadcastWakeLockTimeout:Landroid/os/PowerManager$WakeLock;
...
.method public constructor <init>()V
    ...
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBroadCastBlackguestWakeLock:Z
    ...
    iput v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mGestureKeyCode:I

    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAnimationWindowToken:Landroid/os/IBinder;

    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mScreenOnListener:Landroid/view/WindowManagerPolicy$ScreenOnListener;
...
.method private BlackscreenGestureEnabled(Ljava/lang/String;)Z
    .locals 2
...
.method private PlayGestureAnimation()V
    ...
    invoke-direct {v1, p0, v4}, Lcom/android/internal/policy/impl/PhoneWindowManager$17;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/content/Context;)V
    ...
    invoke-direct {v4, p0, v3, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager$18;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/view/WindowManager;Landroid/widget/ImageView;)V
...
.method static synthetic access$1100(Lcom/android/internal/policy/impl/PhoneWindowManager;)Landroid/view/WindowManagerPolicy$ScreenOnListener;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/policy/impl/PhoneWindowManager;

    .prologue
    .line 129
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mScreenOnListener:Landroid/view/WindowManagerPolicy$ScreenOnListener;
...
.method private finishScreenTurningOn(Landroid/view/WindowManagerPolicy$ScreenOnListener;)V
    ...
    .line 4887
    iput-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAnimationWindowToken:Landroid/os/IBinder;
...
.method private getBlackscreenGestureClassName(Ljava/lang/String;)Ljava/lang/String;
    .locals 3
    .param p1, "name"    # Ljava/lang/String;
    ...
    .line 4051
    .local v0, "subValue":[Ljava/lang/String;
    const/4 v2, 0x2

    aget-object v2, v0, v2

    .line 4053
    .end local v0    # "subValue":[Ljava/lang/String;
    :goto_0
    return-object v2
...
.method private getBlackscreenGesturePackageName(Ljava/lang/String;)Ljava/lang/String;
    .locals 3
    .param p1, "name"    # Ljava/lang/String;
...
.method private handleBlackscreenGesture(ILandroid/view/KeyEvent;)Z
    .locals 21
    .param p1, "keyCode"    # I
    ...
    iput-boolean v2, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBroadCastBlackguestWakeLock:Z
    ...
    const-string v3, "com.zte.camera.Camera"
    ...
    .end local v16    # "intent":Landroid/content/Intent;
    :pswitch_5
    invoke-direct/range {p0 .. p1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->gestureKeyName(I)Ljava/lang/String;

    move-result-object v18

    .line 4159
    .local v18, "settingValue":Ljava/lang/String;
    new-instance v16, Landroid/content/Intent;
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getBlackscreenGesturePackageName(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getBlackscreenGestureClassName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 4171
    .end local v18    # "settingValue":Ljava/lang/String;
    :catch_0
    move-exception v15
    ...
    const-string v4, "application  not found: keyCode="
...
.method private ignoreBlackscreenGestureKey(IZ)Z
    ...
    .line 4079
    invoke-direct {p0, v2}, Lcom/android/internal/policy/impl/PhoneWindowManager;->BlackscreenGestureEnabled(Ljava/lang/String;)Z

    move-result v0

    .line 4080
    .local v0, "enable":Z
    iget v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mGestureKeyCode:I
    ...
    .line 4081
    const-string v4, "zolo"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "ignoreBlackscreenGestureKey, mGestureKeyCode="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mGestureKeyCode:I

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, "   system is busy, ignore this event!"
...
.method private waitForKeyguardWindowDrawn(Landroid/os/IBinder;Landroid/view/WindowManagerPolicy$ScreenOnListener;)V
    ...
    invoke-direct {v2, p0, p2}, Lcom/android/internal/policy/impl/PhoneWindowManager$24;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/view/WindowManagerPolicy$ScreenOnListener;)V

    invoke-interface {v1, p1, v2}, Landroid/view/IWindowManager;->waitForWindowDrawn(Landroid/os/IBinder;Landroid/os/IRemoteCallback;)Z
    ...
    const-string v2, "No lock screen! waitForWindowDrawn false"
    ...
    const-string v3, "No lock screen! windowToken="
...
.method public dismissKeyguardLw()V
    ...
    const-string v1, "android.intent.action.ZTE_DISMISS_KEYGUARD"
...
.method dispatchMediaKeyWithWakeLock(Landroid/view/KeyEvent;)V
    ...
    .line 4658
    :cond_1
    iget-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBroadCastBlackguestWakeLock:Z

    if-ne v1, v2, :cond_2

    .line 4659
    const-string v1, "maas"
    ...
    .line 4660
    iget-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBroadcastWakeLockTimeout:Landroid/os/PowerManager$WakeLock;
    ...
    .line 4662
    iput-boolean v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBroadCastBlackguestWakeLock:Z
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    const-string v5, "PhoneWindowManager.mBroadcastWakeLockTimeout"

    invoke-virtual {v4, v8, v5}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v4

    iput-object v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBroadcastWakeLockTimeout:Landroid/os/PowerManager$WakeLock;
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    invoke-direct {v0, v12, v6}, Lcom/android/internal/policy/impl/PhoneWindowManager;->ignoreBlackscreenGestureKey(IZ)Z
    ...
    invoke-direct {v0, v12, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->handleBlackscreenGesture(ILandroid/view/KeyEvent;)Z
...
.method public screenTurningOn(Landroid/view/WindowManagerPolicy$ScreenOnListener;)V
    ...
    .line 4819
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAnimationWindowToken:Landroid/os/IBinder;

    if-eqz v0, :cond_1

    iget v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mGestureKeyCode:I
