...
.method public run()V
    ...
    .line 536
    .local v6, "mApMonitor":Landroid/net/wifi/WifiMonitor;
    if-eqz v6, :cond_2

    # getter for: Landroid/net/wifi/WifiMonitor;->mMonitoring:Z
    invoke-static {v6}, Landroid/net/wifi/WifiMonitor;->access$000(Landroid/net/wifi/WifiMonitor;)Z
    ...
    const-string v8, "Event DISASSOC"
    ...
    .line 541
    :cond_1
    invoke-direct {p0, v2}, Landroid/net/wifi/WifiMonitor$MonitorThread;->handleAssocEvents(Ljava/lang/String;)V
    ...
    # getter for: Landroid/net/wifi/WifiMonitor;->mStopApMonitor:Z
    ...
    invoke-static {v6, v10}, Landroid/net/wifi/WifiMonitor;->access$202(Landroid/net/wifi/WifiMonitor;Z)Z

    .line 548
    const-string v8, "WifiMonitor"

    const-string/jumbo v9, "wangzhaoxin mStopApMonitor exit monitor"
    ...
    invoke-static {v8, v10}, Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;->access$602(Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;Z)Z
