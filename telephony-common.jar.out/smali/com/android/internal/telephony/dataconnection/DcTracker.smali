...
.field protected m1xcandatacall:I
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    .line 191
    iput v4, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I
...
.method private buildWaitingApns(Ljava/lang/String;I)Ljava/util/ArrayList;
    ...
    iget v7, v7, Lcom/android/internal/telephony/dataconnection/DataProfile;->id:I
    ...
    iget-object v7, v7, Lcom/android/internal/telephony/dataconnection/DataProfile;->apn:Ljava/lang/String;
    ...
    iget-object v7, v7, Lcom/android/internal/telephony/dataconnection/DataProfile;->user:Ljava/lang/String;

    const-string v8, "ctwap@mycdma.cn"
    ...
    const-string v8, "ctnet@mycdma.cn"
    ...
    const-string v8, "PREFERED APN should change , pre apn id="
    ...
    .line 2659
    iput-object v12, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPreferredDp:Lcom/android/internal/telephony/dataconnection/DataProfile;
    ...
    const-string v8, "--zja-- buildWaitingApns add to buildWaitingApns += "
    ...
    .end local v4    # "i$":Ljava/util/Iterator;
    :cond_f
    const-string v7, "buildWaitingApns: but operator different"
...
.method private setupData(Lcom/android/internal/telephony/dataconnection/ApnContext;I)Z
    ...
    .line 1396
    iput-object v6, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPreferredDp:Lcom/android/internal/telephony/dataconnection/DataProfile;
...
.method private showNetworkSelectResultDialog()V
    ...
    const-string v3, "data_roaming_tip"
    ...
    const-string v3, "switch_network_manually"
    ...
    .line 3055
    .local v1, "switch_network_manually":I
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "showNetworkSelectResultDialog, switch_network_manually is "
    ...
    invoke-virtual {v2, v6, v3}, Lcom/android/internal/telephony/PhoneBase;->setPreferredNetworkType(ILandroid/os/Message;)V
    ...
    .line 3062
    :cond_0
    sget-boolean v2, Landroid/util/Config;->ZTE_FEATURE_3G_ONLY_MODE:Z

    if-ne v5, v2, :cond_1

    .line 3063
    const-string v2, "showNetworkSelectResultDialog reset lteswitch to 0 "
    ...
    const-string v3, "lte_func_switch"
    ...
    const-string v2, "com.qualcomm.roamingsettings"

    const-string v3, "com.qualcomm.roamingsettings.DataConnTipActivity"
    ...
    .end local v1    # "switch_network_manually":I
    :cond_2
...
.method private startAlarmForReconnect(ILcom/android/internal/telephony/dataconnection/ApnContext;)V
    ...
    const-string v1, "startAlarmForReconnect: delay="
...
.method private startAlarmForRestartTrySetup(ILcom/android/internal/telephony/dataconnection/ApnContext;)V
    ...
    const-string v1, "startAlarmForRestartTrySetup: delay="
...
.method private trySetupData(Lcom/android/internal/telephony/dataconnection/ApnContext;)Z
    ...
    const-string v12, "trySetupData for type:"
    ...
    const-string v12, "trySetupData with mIsPsRestricted="
    ...
    const-string v12, ",m1xcandatacall="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I
    ...
    .line 809
    iget v11, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I

    if-nez v11, :cond_2

    .line 811
    const-string v11, "ril.card.type"
    ...
    .line 812
    .local v7, "sub0_card_type":Ljava/lang/String;
    iget-object v11, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPhone:Lcom/android/internal/telephony/PhoneBase;
    ...
    const-string v12, "lte_func_switch"
    ...
    .line 813
    .local v3, "mlteswitch":Z
    :goto_0
    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "trySetupData: mlteswitch=="
    ...
    const-string v12, ",sub0_card_type=="
    ...
    const-string v12, ",,lte off or  lte card"
    ...
    .line 817
    iput v9, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I

    .line 818
    const-string v9, "trySetupData00: LTE card serching LTE NW 1xrtt don\'t try connect,delay 20S"
    ...
    invoke-virtual {p0, v9, v11, v12}, Lcom/android/internal/telephony/dataconnection/DcTracker;->sendMessageDelayed(Landroid/os/Message;J)Z

    .line 939
    .end local v3    # "mlteswitch":Z
    .end local v7    # "sub0_card_type":Ljava/lang/String;
    :cond_0
    :goto_1
    return v10

    .restart local v7    # "sub0_card_type":Ljava/lang/String;
    :cond_1
    move v3, v10
    ...
    .line 824
    const-string v9, "trySetupData11 with ,m1xcandatacall=false,return waiting delay timer"
    ...
    const-string v12, "trySetupData22 with ,m1xcandatacall="
    ...
    .line 828
    iput v10, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I
    ...
    invoke-virtual {p1, v10}, Lcom/android/internal/telephony/dataconnection/ApnContext;->setState(Lcom/android/internal/telephony/DctConstants$State;)V
    ...
    .line 841
    const-string v10, "trySetupData: X We\'re on the simulator; assuming connected retValue=true"
    ...
    .line 870
    const-string v9, "trySetupData: if wifi connected don\'t data call,return false"
    ...
    .line 892
    :cond_b
    const-string v9, "trySetupData:  operator = null,don\'t data call,return false"
    ...
    .line 900
    .local v8, "waitingDps":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/telephony/dataconnection/DataProfile;>;"
    ...
    .line 906
    :cond_d
    invoke-virtual {p1, v8}, Lcom/android/internal/telephony/dataconnection/ApnContext;->setWaitingDataProfiles(Ljava/util/ArrayList;)V
    ...
    const-string v11, "trySetupData: Create from mAllDps : "

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-object v11, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mAllDps:Ljava/util/ArrayList;

    invoke-direct {p0, v11}, Lcom/android/internal/telephony/dataconnection/DcTracker;->apnListToString(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    .line 915
    .end local v8    # "waitingDps":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/telephony/dataconnection/DataProfile;>;"
    :cond_e
    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "trySetupData: call setupData, waitingApns : "
    ...
    const-string v11, "trySetupData: cdmaphone, radioTech : "
    ...
    const-string v10, "trySetupData: X retValue="
    ...
    invoke-virtual {v9, v11, v12}, Lcom/android/internal/telephony/PhoneBase;->notifyDataConnectionFailed(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected cleanUpAllConnections(ZLjava/lang/String;)Z
    ...
    const-string v4, "cleanUpAllConnections  set apn type = default, getPhoneType="
...
.method protected cleanUpConnection(ZLcom/android/internal/telephony/dataconnection/ApnContext;)V
    ...
    :cond_2
    :goto_1
    iget-object v5, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mOmhDpt:Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;
...
.method public dispose()V
    ...
    .line 308
    iput v3, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I
...
.method public getOperatorNumeric()Ljava/lang/String;
    ...
    const-string v3, "getOperatorNumberic -and set it to  ICC_OPERATOR_NUMERIC,"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 2866
    iget v5, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I
    ...
    .line 2869
    const-string v4, "EVENT_START_CL_SWITCH, can used 1x data"
    ...
    const-string v6, "onUpdateIcc: Done! getPhoneType="
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    iget v0, v0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I
    ...
    iput v0, v1, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I
    ...
    .line 2172
    const-string v17, "onDataSetupComplete  isPermanentFail: can try setup data call,but don\'t change apn"
    ...
    const-string v18, "onDataSetupComplete  error: getPhoneType="
    ...
    const-string v18, "removeWaitingApn"
...
.method protected onDisconnectDone(ILandroid/os/AsyncResult;)V
    ...
    .line 2289
    invoke-virtual {v0, v6}, Lcom/android/internal/telephony/dataconnection/ApnContext;->setDataProfile(Lcom/android/internal/telephony/dataconnection/DataProfile;)V
    ...
    const-string v4, "onDisconnectDone: apnContext.isReady() ="
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mRequestedApnType:Ljava/lang/String;
    ...
    const-string v4, "onDisconnectDone: ---cdma retry ="
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/dataconnection/DcTracker;->retryAfterDisconnected(Ljava/lang/String;)Z
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/dataconnection/ApnContext;->getDependencyMet()Z

    move-result v4

    invoke-direct {p0, v3, v7, v4}, Lcom/android/internal/telephony/dataconnection/DcTracker;->applyNewState(Lcom/android/internal/telephony/dataconnection/ApnContext;ZZ)V
    ...
    .line 2346
    .end local v2    # "restartRadioAfterProvisioning":Z
    :cond_9
    iget-object v3, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mApnContexts:Ljava/util/concurrent/ConcurrentHashMap;
...
.method protected onUpdateIcc()Z
    ...
    .line 3011
    iput v7, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I

    .line 3012
    const-string v5, "onUpdateIcc: dataRat is 0. return!"
    ...
    const-string v8, "onUpdateIcc: dataRat is change from 6 to radio--"
    ...
    iput v5, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I
    ...
    const-string v8, "New records found "
    ...
    const-string v6, "onUpdateIcc: dataRat is change to 6 reset -m1xcandatacall="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->m1xcandatacall:I
