...
.method protected dispatchNormalMessage(Lcom/android/internal/telephony/SmsMessageBase;)I
    ...
    const-string v2, "InboundSmsHandler.dispatchNormalMessage() 01"
    ...
    .line 560
    invoke-virtual/range {p0 .. p1}, Lcom/android/internal/telephony/InboundSmsHandler;->isSelfRegMessage(Lcom/android/internal/telephony/SmsMessageBase;)Z
    ...
    .line 570
    const-string v2, "android.provider.Telephony.SELF_REG_MESSAGE"

    invoke-virtual {v7, v2}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    .line 572
    const-string v2, "InboundSmsHandler.dispatchNormalMessage() 01_1"
    ...
    iget-object v6, v0, Lcom/android/internal/telephony/InboundSmsHandler;->mContext:Landroid/content/Context;
    ...
    invoke-virtual/range {v6 .. v14}, Landroid/content/Context;->sendOrderedBroadcast(Landroid/content/Intent;Ljava/lang/String;ILandroid/content/BroadcastReceiver;Landroid/os/Handler;ILjava/lang/String;Landroid/os/Bundle;)V
    ...
    :cond_2
    const-string v2, "InboundSmsHandler.dispatchNormalMessage() 02"
    ...
    .line 590
    .local v21, "portAddrs":Lcom/android/internal/telephony/SmsHeader$PortAddrs;
    if-eqz v21, :cond_4
    ...
    iget v15, v0, Lcom/android/internal/telephony/SmsHeader$ConcatRef;->refNumber:I
    ...
    invoke-direct/range {v8 .. v18}, Lcom/android/internal/telephony/InboundSmsTracker;-><init>([BJIZLjava/lang/String;IIIZ)V

    .line 598
    .end local v19    # "concatRef":Lcom/android/internal/telephony/SmsHeader$ConcatRef;
    .end local v21    # "portAddrs":Lcom/android/internal/telephony/SmsHeader$PortAddrs;
    ...
    .restart local v21    # "portAddrs":Lcom/android/internal/telephony/SmsHeader$PortAddrs;
    :cond_4
    const/4 v5, -0x1
