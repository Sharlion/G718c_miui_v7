...
.field private static final EVENT_CHECK_LOAD_TOTALLY_DONE:I = 0x16

.field private static final EVENT_LOAD_CDMA_DONE:I = 0xa

.field private static final EVENT_LOAD_DONE:I = 0x1

.field private static final EVENT_LOAD_GSM_DONE:I = 0xb

.field private static final EVENT_LOAD_MAIN_SMS_DONE:I = 0x14

.field private static final EVENT_LOAD_ROAM_SMS_DONE:I = 0x15
...
.field private static cdmaLoaded:Z


# instance fields
.field private final MAX_SMS_COUNT_OF_APP_TYPE:I

.field private final SIM_APPTYPE_CSIM:I

.field private final SIM_APPTYPE_RUIM:I

.field private final SIM_APPTYPE_SIM:I

.field private final SIM_APPTYPE_UNKNOWN:I

.field private final SIM_APPTYPE_USIM:I
...
.field private mLoadMainDone:Z

.field private mLoadMainSms:Ljava/util/List;
...
.field private mLoadRoamDone:Z

.field private mLoadRoamSms:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method static constructor <clinit>()V
    ...
    .line 93
    sput-boolean v0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->cdmaLoaded:Z
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    .line 100
    iput-boolean v1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadMainDone:Z

    .line 101
    iput-boolean v1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadRoamDone:Z

    .line 103
    iput v1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->SIM_APPTYPE_UNKNOWN:I

    .line 104
    const/4 v0, 0x1

    iput v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->SIM_APPTYPE_SIM:I

    .line 105
    const/4 v0, 0x2

    iput v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->SIM_APPTYPE_USIM:I

    .line 106
    const/4 v0, 0x3

    iput v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->SIM_APPTYPE_RUIM:I

    .line 107
    const/4 v0, 0x4

    iput v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->SIM_APPTYPE_CSIM:I

    .line 109
    const/16 v0, 0x3e8

    iput v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->MAX_SMS_COUNT_OF_APP_TYPE:I

    .line 114
    iput v1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->SimSmsRecordSize:I
...
.method static synthetic access$200()Z
    ...
    .prologue
    .line 69
    sget-boolean v0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->cdmaLoaded:Z
...
.method static synthetic access$202(Z)Z
    ...
    .prologue
    .line 69
    sput-boolean p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->cdmaLoaded:Z

    return p0
.end method

.method static synthetic access$300(Lcom/android/internal/telephony/IccSmsInterfaceManager;)Ljava/util/List;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/IccSmsInterfaceManager;

    .prologue
    .line 69
    iget-object v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadMainSms:Ljava/util/List;

    return-object v0
.end method

.method static synthetic access$302(Lcom/android/internal/telephony/IccSmsInterfaceManager;Ljava/util/List;)Ljava/util/List;
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/IccSmsInterfaceManager;
    .param p1, "x1"    # Ljava/util/List;
    ...
    .prologue
    .line 69
    iput-object p1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadMainSms:Ljava/util/List;
...
.method static synthetic access$400(Lcom/android/internal/telephony/IccSmsInterfaceManager;)Z
    ...
    .prologue
    .line 69
    iget-boolean v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadMainDone:Z
...
.method static synthetic access$402(Lcom/android/internal/telephony/IccSmsInterfaceManager;Z)Z
    ...
    .prologue
    .line 69
    iput-boolean p1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadMainDone:Z

    return p1
.end method

.method static synthetic access$500(Lcom/android/internal/telephony/IccSmsInterfaceManager;)Ljava/util/List;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/IccSmsInterfaceManager;

    .prologue
    .line 69
    iget-object v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadRoamSms:Ljava/util/List;

    return-object v0
.end method

.method static synthetic access$502(Lcom/android/internal/telephony/IccSmsInterfaceManager;Ljava/util/List;)Ljava/util/List;
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/IccSmsInterfaceManager;
    .param p1, "x1"    # Ljava/util/List;
    ...
    .prologue
    .line 69
    iput-object p1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadRoamSms:Ljava/util/List;

    return-object p1
.end method

.method static synthetic access$600(Lcom/android/internal/telephony/IccSmsInterfaceManager;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/IccSmsInterfaceManager;

    .prologue
    .line 69
    iget-boolean v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadRoamDone:Z

    return v0
.end method

.method static synthetic access$602(Lcom/android/internal/telephony/IccSmsInterfaceManager;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/IccSmsInterfaceManager;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 69
    iput-boolean p1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadRoamDone:Z

    return p1
.end method

.method static synthetic access$700(Lcom/android/internal/telephony/IccSmsInterfaceManager;[Lcom/android/internal/telephony/gsm/SmsBroadcastConfigInfo;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/IccSmsInterfaceManager;
...
.method public static isCdmaSms([B)Z
    .locals 7
    .param p0, "pdu"    # [B
...
.method private loadAllSmsOnIcc(Lcom/android/internal/telephony/uicc/IccFileHandler;)V
    .locals 13
    ...
    .line 721
    .local v2, "fhRoam":Lcom/android/internal/telephony/uicc/IccFileHandler;
    const/4 v5, 0x0

    .line 723
    .local v5, "roamSmsPath":Ljava/lang/String;
    invoke-direct {p0}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->resetLoadData()V
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/PhoneBase;->getCurrentUiccAppType()Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
    ...
    const-string v7, "[DeftLog]loadAllSmsOnIcc(), mPhone.getCurrentUiccAppType() is "
    ...
    .line 731
    .local v4, "responseRoam":Landroid/os/Message;
    sget-object v6, Lcom/android/internal/telephony/IccSmsInterfaceManager$2;->$SwitchMap$com$android$internal$telephony$uicc$IccCardApplicationStatus$AppType:[I
    ...
    const-string v7, "[DeftLog]fhRoam.loadEFLinearFixedAll(), fhRoam = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    invoke-virtual {v2}, Lcom/android/internal/telephony/uicc/IccFileHandler;->toString()Ljava/lang/String;
    ...
    .line 764
    invoke-virtual {v2, v9, v4}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFLinearFixedAll(ILandroid/os/Message;)V

    .line 779
    :goto_1
    invoke-virtual {p1, v9, v3}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFLinearFixedAll(ILandroid/os/Message;)V
    ...
    invoke-virtual {v6, v11, v7, v8}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
    ...
    invoke-virtual {v6, v7}, Lcom/android/internal/telephony/PhoneBase;->getIccFileHandler(Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;)Lcom/android/internal/telephony/uicc/IccFileHandler;
    ...
    invoke-virtual {v6, v11, v12, v8}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;

    move-result-object v4

    .line 748
    invoke-virtual {p1, v9}, Lcom/android/internal/telephony/uicc/IccFileHandler;->getRoamSmsEFPath(I)Ljava/lang/String;
    ...
    invoke-virtual {v6, v10, v12, v8}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
    ...
    const-string v7, "[DeftLog]loadEFLinearFixedAll() roamSmsPath = "
    ...
    .line 769
    invoke-virtual {p1, v9, v5, v4}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFLinearFixedAll(ILjava/lang/String;Landroid/os/Message;)V

    goto :goto_1

    .line 773
    :cond_1
    const-string v6, "[DeftLog]fhRoam == null && roamSmsPath == null, now sendMessage(checkMsg)"
    ...
    .line 775
    .local v1, "checkMsg":Landroid/os/Message;
    iput-boolean v12, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadRoamDone:Z
...
.method private resetLoadData()V
    .locals 1
    ...
    .line 702
    iput-boolean v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadMainDone:Z

    .line 703
    iput-boolean v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mLoadRoamDone:Z
...
.method protected buildValidRawData(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v5}, Lcom/android/internal/telephony/SmsRawData;-><init>([B)V

    .line 1180
    .local v2, "data":Lcom/android/internal/telephony/SmsRawData;
    add-int/lit8 v5, v3, 0x1

    invoke-virtual {v2, v5}, Lcom/android/internal/telephony/SmsRawData;->setIndexOnIcc(I)V
...
.method protected buildValidRawData(Ljava/util/ArrayList;I)Ljava/util/ArrayList;
    .locals 7
    .param p2, "appType"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public copyMessageToIccEf(I[B[BI)Z
    ...
    const-string v5, "[DeftLog]copyMessageToIccEf 2: status="
    ...
    invoke-static {p2}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->isCdmaSms([B)Z

    move-result v1

    .line 621
    .local v1, "isCdmaSms":Z
    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "[DeftLog]mPhone = "
    ...
    const-string v5, "[DeftLog]mPhone.mCi.writeSmsToSim() phone name = "
    ...
    invoke-interface {v3, p1, v5, v6, v2}, Lcom/android/internal/telephony/CommandsInterface;->writeSmsToSim(ILjava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v5, "[DeftLog]mPhone.mCi.writeSmsToRuim() phone name = "
...
.method public getAllMessagesFromIccEf()Ljava/util/List;
    ...
    .prologue
    .line 657
    const-string v2, "getAllMessagesFromEF (1)"
    ...
    .line 679
    :cond_0
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->loadAllSmsOnIcc(Lcom/android/internal/telephony/uicc/IccFileHandler;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .local v0, "e":Ljava/lang/InterruptedException;
    :try_start_3
    const-string v2, "interrupted while trying to load from the Icc"
...
.method public updateMessageOnIccEf(Ljava/lang/String;II[B)Z
    ...
    const-string v2, "[DeftLog]updateMessageOnIccEf() , STATUS_ON_ICC_FREE , phoneType ="
    ...
    .line 440
    invoke-direct {p0, p2}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->isGsmIndex(I)Z
    ...
    .line 444
    const-string v1, "[DeftLog]mPhone.mCi.deleteSmsOnSim()"
    ...
    .line 449
    .restart local v7    # "isGsmSms":Z
    :cond_0
    :try_start_3
    const-string v1, "[DeftLog]mPhone.mCi.deleteSmsOnRuim()"
