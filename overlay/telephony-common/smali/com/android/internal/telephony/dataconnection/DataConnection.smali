...
.method private onConnect(Lcom/android/internal/telephony/dataconnection/DataConnection$ConnectionParams;)V
    ...
    .line 419
    new-instance v26, Lcom/android/internal/telephony/dataconnection/DataCallResponse;

    invoke-direct/range {v26 .. v26}, Lcom/android/internal/telephony/dataconnection/DataCallResponse;-><init>()V

    .line 420
    .local v26, "response":Lcom/android/internal/telephony/dataconnection/DataCallResponse;
    move-object/from16 v0, p0
    ...
    invoke-static {v11, v0, v2}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;

    .line 434
    move-object/from16 v0, p0

    invoke-virtual {v0, v11}, Lcom/android/internal/telephony/dataconnection/DataConnection;->sendMessage(Landroid/os/Message;)V
    ...
    .line 496
    .end local v26    # "response":Lcom/android/internal/telephony/dataconnection/DataCallResponse;
    :goto_0
    return-void
    ...
    iget v0, v2, Lcom/android/internal/telephony/dataconnection/DataProfile;->authType:I

    move/from16 v22, v0

    .line 461
    .local v22, "authType":I
    const/4 v2, -0x1
    ...
    iget-object v0, v2, Lcom/android/internal/telephony/dataconnection/DataProfile;->types:[Ljava/lang/String;
    ...
    .end local v10    # "isDefault":I
    .end local v11    # "msg":Landroid/os/Message;
    .end local v21    # "arr$":[Ljava/lang/String;
    .end local v22    # "authType":I
    .end local v23    # "dataProfileId":I
    .end local v24    # "i$":I
    .end local v25    # "len$":I
    ...
    iget v0, v0, Lcom/android/internal/telephony/dataconnection/DataConnection$ConnectionParams;->mProfileId:I

    move/from16 v23, v0

    .restart local v23    # "dataProfileId":I
    goto :goto_1

    .line 462
    .restart local v11    # "msg":Landroid/os/Message;
    .restart local v22    # "authType":I
    :cond_4
    const/16 v22, 0x3
    ...
    iget-object v5, v0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mApnSetting:Lcom/android/internal/telephony/dataconnection/DataProfile;

    iget-object v5, v5, Lcom/android/internal/telephony/dataconnection/DataProfile;->apn:Ljava/lang/String;
    ...
    invoke-interface/range {v2 .. v11}, Lcom/android/internal/telephony/CommandsInterface;->setupDataCall(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/Message;)V
    ...
    iget-object v12, v2, Lcom/android/internal/telephony/PhoneBase;->mCi:Lcom/android/internal/telephony/CommandsInterface;
    ...
    iget-object v15, v2, Lcom/android/internal/telephony/dataconnection/DataProfile;->apn:Ljava/lang/String;

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mApnSetting:Lcom/android/internal/telephony/dataconnection/DataProfile;

    iget-object v0, v2, Lcom/android/internal/telephony/dataconnection/DataProfile;->user:Ljava/lang/String;
    ...
    iget-object v0, v2, Lcom/android/internal/telephony/dataconnection/DataProfile;->password:Ljava/lang/String;
    ...
    invoke-interface/range {v12 .. v20}, Lcom/android/internal/telephony/CommandsInterface;->setupDataCall(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
