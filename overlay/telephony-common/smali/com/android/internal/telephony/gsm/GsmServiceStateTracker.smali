...
.field public static final DM_FOR_H2X_OR_H3X_CU:I = 0x7fffffff
...
.method public constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 169
    iput v4, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mCurState:I
...
.method private pollStateDone()V
    ...
    .line 1019
    sget-boolean v37, Lmiui/os/Build;->IS_DEBUGGABLE:Z
    ...
    sget-object v38, Lcom/android/internal/telephony/CommandsInterface$RadioState;->RADIO_ON:Lcom/android/internal/telephony/CommandsInterface$RadioState;
    ...
    .line 1276
    const-string v37, "Data Deregistered"

    move-object/from16 v0, p0

    move-object/from16 v1, v37

    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->sendIssueIntent(Ljava/lang/String;)V
    ...
    .line 1282
    const-string v37, "Voice Deregistered"
...
.method public getCellLocation()Landroid/telephony/CellLocation;
    ...
    .line 1644
    .local v9, "isCidEqualsH2xCuDmValue":Z
    sget-boolean v11, Lmiui/os/Build;->IS_HONGMI_TWOX_CU:Z

    if-nez v11, :cond_0

    sget-boolean v11, Lmiui/os/Build;->IS_HONGMI_THREEX_CU:Z
    ...
    const-string v12, "getCellLocation(): X good mCellLoc="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mCellLoc:Landroid/telephony/gsm/GsmCellLocation;
    ...
    .line 1653
    .local v10, "result":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    if-eqz v10, :cond_a
    ...
    invoke-virtual {v6, v11, v12}, Landroid/telephony/gsm/GsmCellLocation;->setLacAndCid(II)V
    ...
    invoke-virtual {v6, v11}, Landroid/telephony/gsm/GsmCellLocation;->setPsc(I)V
    ...
    const-string v12, "getCellLocation(): X ret GSM info="
    ...
    :cond_6
    instance-of v11, v7, Landroid/telephony/CellInfoWcdma;
    ...
    const-string v12, "getCellLocation(): X ret WCDMA info="
    ...
    :cond_7
    instance-of v11, v7, Landroid/telephony/CellInfoLte;
    ...
    const-string v12, "getCellLocation(): possible LTE cellLocOther="
    ...
    const-string v12, "getCellLocation(): X ret best answer cellLocOther="
    ...
    const-string v12, "getCellLocation(): X empty mCellLoc and CellInfo mCellLoc="
    ...
    invoke-virtual {v11, v12, v13}, Landroid/telephony/gsm/GsmCellLocation;->setLacAndCid(II)V
...
.method protected getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSlotId()I

    move-result v0

    invoke-static {p1, v0, p2}, Landroid/telephony/TelephonyManager;->getTelephonyProperty(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-interface/range {v22 .. v23}, Lcom/android/internal/telephony/CommandsInterface;->getPreferredNetworkType(Landroid/os/Message;)V
    ...
    :cond_4
    sget-boolean v22, Lmiui/os/Build;->IS_MITHREE_TDSCDMA:Z
    ...
    .end local v3    # "ar":Landroid/os/AsyncResult;
    :pswitch_12
    const-string v22, "EVENT_NEED_SET_PREFERRED_NETWORK_TYPE"
    ...
    .line 485
    .local v15, "preferredNetworkModeInModem":I
    iget-object v0, v3, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    .line 492
    .local v14, "preferredNetworkModeInAP":I
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSlotId()I
    ...
    const-string v24, "preferred network in modem is "
    ...
    const-string v24, " preferred network in AP is "
    ...
    .line 502
    sget-boolean v22, Lmiui/os/Build;->IS_CM_CUSTOMIZATION_TEST:Z
    ...
    const-string v23, "CMCC lab test, prefer modem settings"
    ...
    invoke-interface/range {v22 .. v23}, Lcom/android/internal/telephony/CommandsInterface;->getNetworkSelectionMode(Landroid/os/Message;)V
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSlotId()I
    ...
    const-string v23, "preferrred network mode doesn\'t match. Restore"
    ...
    invoke-interface/range {v22 .. v22}, Lcom/android/internal/telephony/CommandsInterface;->setCurrentPreferredNetworkType()V

    goto :goto_5

    .line 517
    .end local v3    # "ar":Landroid/os/AsyncResult;
    .end local v14    # "preferredNetworkModeInAP":I
    .end local v15    # "preferredNetworkModeInModem":I
    :pswitch_13
    const-string v22, "EVENT_NEED_SET_NETWORK_SELECTION_TYPE"
    ...
    .line 520
    .local v10, "networkSelectionModeInModem":I
    iget-object v0, v3, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    const-string v23, "network_selection_key"

    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/telephony/gsm/GSMPhone;->getPreferenceKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 529
    .local v9, "networkSelectionModeInAP":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v24, "network selection mode in modem is "
    ...
    const-string v24, " network selection mode in AP is "
    ...
    .line 536
    .local v17, "selectionModeIsManual_AP":Z
    :goto_6
    if-nez v10, :cond_f
    ...
    .line 538
    .local v16, "selecitonModeIsManual_Modem":Z
    :goto_7
    if-nez v18, :cond_d
    ...
    const-string v23, "network selection mode doesn\'t match. Restore"
    ...
    .line 535
    .end local v16    # "selecitonModeIsManual_Modem":Z
    .end local v17    # "selectionModeIsManual_AP":Z
    :cond_e
    const/16 v17, 0x1
    ...
    .line 536
    .restart local v17    # "selectionModeIsManual_AP":Z
    :cond_f
    const/16 v16, 0x1
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    .line 750
    sget-boolean v21, Lmiui/os/Build;->IS_HONGMI_TWOX_CU:Z

    if-nez v21, :cond_a

    sget-boolean v21, Lmiui/os/Build;->IS_HONGMI_THREEX_CU:Z
...
.method protected updateSpnDisplay()V
    ...
    invoke-virtual {p0, v10, v7}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->getSpnOverride(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 632
    const-string v10, "updateSpnDisplay: emergency only or no service, don\'t show spn"
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->getSpnUpdateActionName()Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mPhoneBase:Lcom/android/internal/telephony/PhoneBase;

    invoke-virtual {v9}, Lcom/android/internal/telephony/PhoneBase;->getSlotId()I
    ...
    .line 638
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->getPlmn()Ljava/lang/String;
    ...
    .line 644
    const-string v10, "updateSpnDisplay: not roaming, dont\' show spn"
