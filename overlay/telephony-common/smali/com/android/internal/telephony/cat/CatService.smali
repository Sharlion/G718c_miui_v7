...
.field private static final sInstance:[Lcom/android/internal/telephony/cat/CatService;
...
.method private constructor <init>(Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/uicc/UiccCardApplication;Lcom/android/internal/telephony/uicc/IccRecords;Landroid/content/Context;Lcom/android/internal/telephony/uicc/IccFileHandler;Lcom/android/internal/telephony/uicc/UiccCard;)V
    ...
    .line 154
    :cond_2
    iput-object p3, p0, Lcom/android/internal/telephony/cat/CatService;->mIccRecords:Lcom/android/internal/telephony/uicc/IccRecords;

    .line 155
    iput-object p2, p0, Lcom/android/internal/telephony/cat/CatService;->mUiccApplication:Lcom/android/internal/telephony/uicc/UiccCardApplication;

    .line 157
    iget-object v0, p0, Lcom/android/internal/telephony/cat/CatService;->mIccRecords:Lcom/android/internal/telephony/uicc/IccRecords;
...
.method public static getInstance(Lcom/android/internal/telephony/CommandsInterface;Landroid/content/Context;Lcom/android/internal/telephony/uicc/UiccCard;)Lcom/android/internal/telephony/cat/CatService;
    ...
    .line 754
    :try_start_0
    invoke-interface {p0}, Lcom/android/internal/telephony/CommandsInterface;->getInstanceId()I
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/cat/CatService;->mIccRecords:Lcom/android/internal/telephony/uicc/IccRecords;
    ...
    invoke-virtual {v0, v3, v2}, Lcom/android/internal/telephony/cat/CatService;->update(Lcom/android/internal/telephony/uicc/IccRecords;Lcom/android/internal/telephony/uicc/UiccCardApplication;)V
...
.method private handleCmdResponse(Lcom/android/internal/telephony/cat/CatResponseMessage;)V
    ...
    .line 969
    .local v15, "type":Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/cat/CatResponseMessage;->setAdditionalInfo(I)V
    ...
    iget v3, v0, Lcom/android/internal/telephony/cat/CatResponseMessage;->mEventValue:I
    ...
    iget v8, v0, Lcom/android/internal/telephony/cat/CatResponseMessage;->mEventValue:I
    ...
    iget-object v11, v0, Lcom/android/internal/telephony/cat/CatResponseMessage;->mAddedInfo:[B
...
.method private handleCommand(Lcom/android/internal/telephony/cat/CommandParams;Z)V
    ...
    .line 333
    invoke-direct/range {p0 .. p1}, Lcom/android/internal/telephony/cat/CatService;->sendRefresh(Lcom/android/internal/telephony/cat/CommandParams;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/cat/CatService;->handleSendSS(Lcom/android/internal/telephony/cat/CatCmdMessage;)V
...
.method private handleSendSS(Lcom/android/internal/telephony/cat/CatCmdMessage;)V
    .locals 14
    .param p1, "currntCmd"    # Lcom/android/internal/telephony/cat/CatCmdMessage;

    .prologue
    .line 1146
    invoke-virtual {p1}, Lcom/android/internal/telephony/cat/CatCmdMessage;->getCallSettings()Lcom/android/internal/telephony/cat/CatCmdMessage$CallSettings;
    ...
    :try_start_0
    invoke-static {v8}, Lcom/android/internal/telephony/lc/SsProcesser;->newFromSS(Ljava/lang/String;)Lcom/android/internal/telephony/lc/SsProcesser;

    move-result-object v9

    .line 1152
    .local v9, "ssCode":Lcom/android/internal/telephony/lc/SsProcesser;
    invoke-virtual {v9}, Lcom/android/internal/telephony/lc/SsProcesser;->getProcessResult()I
    ...
    .end local v9    # "ssCode":Lcom/android/internal/telephony/lc/SsProcesser;
    .end local v10    # "ssType":I
    :cond_0
    :goto_0
    return-void
    ...
    .restart local v9    # "ssCode":Lcom/android/internal/telephony/lc/SsProcesser;
    .restart local v10    # "ssType":I
    :pswitch_0
    iget-object v0, p0, Lcom/android/internal/telephony/cat/CatService;->mCmdIf:Lcom/android/internal/telephony/CommandsInterface;

    const/16 v1, 0x15

    iget-object v2, p1, Lcom/android/internal/telephony/cat/CatCmdMessage;->mCmdDet:Lcom/android/internal/telephony/cat/CommandDetails;

    invoke-virtual {p0, v1, v2}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget v1, v9, Lcom/android/internal/telephony/lc/SsProcesser;->clirMode:I

    const/16 v2, 0x15

    iget-object v3, p1, Lcom/android/internal/telephony/cat/CatCmdMessage;->mCmdDet:Lcom/android/internal/telephony/cat/CommandDetails;

    invoke-virtual {p0, v2, v3}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget v1, v9, Lcom/android/internal/telephony/lc/SsProcesser;->reason:I

    iget v2, v9, Lcom/android/internal/telephony/lc/SsProcesser;->serviceClass:I

    iget-object v3, v9, Lcom/android/internal/telephony/lc/SsProcesser;->sia:Ljava/lang/String;

    const/16 v4, 0x15

    iget-object v5, p1, Lcom/android/internal/telephony/cat/CatCmdMessage;->mCmdDet:Lcom/android/internal/telephony/cat/CommandDetails;

    invoke-virtual {p0, v4, v5}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget v1, v9, Lcom/android/internal/telephony/lc/SsProcesser;->cfAction:I

    iget v2, v9, Lcom/android/internal/telephony/lc/SsProcesser;->reason:I

    iget v3, v9, Lcom/android/internal/telephony/lc/SsProcesser;->serviceClass:I

    iget-object v4, v9, Lcom/android/internal/telephony/lc/SsProcesser;->sia:Ljava/lang/String;

    iget v5, v9, Lcom/android/internal/telephony/lc/SsProcesser;->time:I

    const/16 v6, 0x15

    iget v11, v9, Lcom/android/internal/telephony/lc/SsProcesser;->isSettingUnconditionalVoice:I

    iget v12, v9, Lcom/android/internal/telephony/lc/SsProcesser;->isEnableDesired:I

    iget-object v13, p1, Lcom/android/internal/telephony/cat/CatCmdMessage;->mCmdDet:Lcom/android/internal/telephony/cat/CommandDetails;

    invoke-virtual {p0, v6, v11, v12, v13}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    iget-object v1, v9, Lcom/android/internal/telephony/lc/SsProcesser;->facility:Ljava/lang/String;

    iget-object v2, v9, Lcom/android/internal/telephony/lc/SsProcesser;->sia:Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/lc/SsProcesser;->isActivate()Z

    move-result v2

    iget-object v3, v9, Lcom/android/internal/telephony/lc/SsProcesser;->sia:Ljava/lang/String;

    iget v4, v9, Lcom/android/internal/telephony/lc/SsProcesser;->serviceClass:I
    ...
    invoke-virtual {p0, v5, v6}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget-object v2, v9, Lcom/android/internal/telephony/lc/SsProcesser;->sib:Ljava/lang/String;

    iget-object v3, v9, Lcom/android/internal/telephony/lc/SsProcesser;->sic:Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v4}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget v1, v9, Lcom/android/internal/telephony/lc/SsProcesser;->serviceClass:I
...
.method private sendRefresh(Lcom/android/internal/telephony/cat/CommandParams;)V
    .locals 11
    .param p1, "cmdParams"    # Lcom/android/internal/telephony/cat/CommandParams;
    ...
    check-cast v9, Lcom/android/internal/telephony/cat/RefreshParams;

    .line 1113
    .local v9, "refreshParams":Lcom/android/internal/telephony/cat/RefreshParams;
    ...
    .line 1114
    iget-object v0, v9, Lcom/android/internal/telephony/cat/RefreshParams;->fileList:[B
    ...
    .line 1116
    .local v10, "sEFList":Ljava/lang/String;
    iget v8, v9, Lcom/android/internal/telephony/cat/RefreshParams;->refMode:I
    ...
    invoke-interface {v0, v8, v7, v10, v5}, Lcom/android/internal/telephony/CommandsInterface;->sendRefresh(IILjava/lang/String;Landroid/os/Message;)V
    ...
    const-string v1, "====refreshParams.numFiles="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v1, v9, Lcom/android/internal/telephony/cat/RefreshParams;->numFiles:I
    ...
    .line 1123
    iget v0, v9, Lcom/android/internal/telephony/cat/RefreshParams;->numFiles:I

    if-ne v0, v2, :cond_0

    iget-object v0, v9, Lcom/android/internal/telephony/cat/RefreshParams;->fileList:[B

    invoke-direct {p0, v0}, Lcom/android/internal/telephony/cat/CatService;->checkADN([B)Z
    ...
    :cond_0
    :goto_1
    const-string v0, "====REFRESH sendTerminalResponse  "
    ...
    .end local v8    # "nRefMode":I
    .end local v10    # "sEFList":Ljava/lang/String;
    :cond_1
    return-void

    .line 1117
    .restart local v8    # "nRefMode":I
    .restart local v10    # "sEFList":Ljava/lang/String;
    :cond_2
    iget-object v0, v9, Lcom/android/internal/telephony/cat/RefreshParams;->fileList:[B
...
.method public dispose()V
    ...
    .line 198
    :cond_0
    iget-object v0, p0, Lcom/android/internal/telephony/cat/CatService;->mUiccApplication:Lcom/android/internal/telephony/uicc/UiccCardApplication;
...
.method protected update(Lcom/android/internal/telephony/uicc/IccRecords;Lcom/android/internal/telephony/uicc/UiccCardApplication;)V
    .locals 3
    .param p1, "ir"    # Lcom/android/internal/telephony/uicc/IccRecords;
    .param p2, "ca"    # Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    .line 780
    :cond_1
    const-string v0, "Reinitialize the Service with SIMRecords and UiccCardApplication"

    invoke-static {p0, v0}, Lcom/android/internal/telephony/cat/CatLog;->d(Ljava/lang/Object;Ljava/lang/String;)V

    .line 782
    iput-object p1, p0, Lcom/android/internal/telephony/cat/CatService;->mIccRecords:Lcom/android/internal/telephony/uicc/IccRecords;
    ...
    .line 787
    const-string v0, "sr changed reinitialize and return current sInstance"
