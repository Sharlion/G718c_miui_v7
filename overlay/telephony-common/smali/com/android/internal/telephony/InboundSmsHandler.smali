...
.method private beforeDispatchIntent(Landroid/content/Intent;Ljava/lang/String;ILandroid/content/BroadcastReceiver;)Z
    ...
    invoke-direct {v0, v9}, Lcom/android/internal/telephony/InboundSmsHandler;->checkSmsCmd([[B)Z
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/InboundSmsHandler;->obtainMessage(I)Landroid/os/Message;

    move-result-object v14

    move-object/from16 v0, p0

    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/InboundSmsHandler;->deferMessage(Landroid/os/Message;)V
    :try_end_2
...
.method processMessagePart(Lcom/android/internal/telephony/InboundSmsTracker;)Z
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/telephony/SmsMessage;->getDisplayOriginatingAddress()Ljava/lang/String;
...
.method protected storeVoiceMailCount()V
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/PhoneBase;->getSlotId()I
