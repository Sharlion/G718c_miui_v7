...
.method public static compareLoosely(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 573
    .end local v0    # "aPlusFirst":Z
    .end local v1    # "bPlusFirst":Z
    :cond_13
    const/4 v0, 0x0
    ...
    .line 582
    .restart local v1    # "bPlusFirst":Z
    :cond_15
    const-string v12, "gsm.sim.operator.iso-country"
    ...
    invoke-static {p0, v12}, Landroid/telephony/PhoneNumberUtils;->matchBrazilCarrierCodeAndPrefix(Ljava/lang/String;I)Z
    ...
    invoke-static {p1, v12}, Landroid/telephony/PhoneNumberUtils;->matchBrazilCarrierCodeAndPrefix(Ljava/lang/String;I)Z
...
.method public static compareStrictly(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 632
    :cond_3
    const-string v18, "gsm.sim.operator.iso-country"
    ...
    invoke-static {v0, v1}, Landroid/telephony/PhoneNumberUtils;->matchBrazilCarrierCodeAndPrefix(Ljava/lang/String;I)Z
    ...
    .line 635
    .end local v5    # "bothHasCountryCallingCode":Z
    .end local v6    # "cccA":Landroid/telephony/PhoneNumberUtils$CountryCallingCodeAndNewIndex;
    .end local v7    # "cccB":Landroid/telephony/PhoneNumberUtils$CountryCallingCodeAndNewIndex;
    .end local v10    # "forwardIndexA":I
    .end local v11    # "forwardIndexB":I
    .end local v13    # "okToIgnorePrefix":Z
    .end local v16    # "trunkPrefixIsOmittedA":Z
    .end local v17    # "trunkPrefixIsOmittedB":Z
    :cond_6
    invoke-virtual/range {p0 .. p0}, Ljava/lang/String;->length()I
    ...
    .line 663
    .restart local v5    # "bothHasCountryCallingCode":Z
    .restart local v6    # "cccA":Landroid/telephony/PhoneNumberUtils$CountryCallingCodeAndNewIndex;
    .restart local v7    # "cccB":Landroid/telephony/PhoneNumberUtils$CountryCallingCodeAndNewIndex;
    .restart local v10    # "forwardIndexA":I
    .restart local v11    # "forwardIndexB":I
    .restart local v13    # "okToIgnorePrefix":Z
    .restart local v16    # "trunkPrefixIsOmittedA":Z
    .restart local v17    # "trunkPrefixIsOmittedB":Z
    :cond_8
    const/4 v13, 0x0
...
.method public static getNumberFromIntent(Landroid/content/Intent;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lmiui/telephony/MultiSimManager;->getPreferredVoiceSlotId()I
    ...
    .line 187
    .local v11, "slotId":I
    invoke-static {v11}, Landroid/telephony/TelephonyManager;->getDefault(I)Landroid/telephony/TelephonyManager;
...
.method private static isEmergencyNumberInternal(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v10}, Lmiui/telephony/MultiSimManager;->getMultiSimCount()I
...
.method public static isVoiceMailNumber(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0}, Landroid/telephony/PhoneNumberUtils;->isVoiceMailNumber(Ljava/lang/String;I)Z
...
.method public static replaceCdmaInternationalAccessCode(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Landroid/telephony/PhoneNumberUtils;->isChinaMobileNumber(Ljava/lang/String;)Z
